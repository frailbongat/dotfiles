...
10. Gate the promoted diff against taste §4.7 and §9, then run **deslop** and `/skill:unslop` over every string you wrote. Placeholder names, `lorem`, and invented metrics fail the gate rather than counting as nits.
